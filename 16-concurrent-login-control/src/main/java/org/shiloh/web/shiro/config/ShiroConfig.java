...
import org.shiloh.web.shiro.filter.KickOutSessionControlFilter;
...
public class ShiroConfig {
     ...
     */
    @Bean
    public AccessControlFilter concurrentLoginControlFilter() {
        final KickOutSessionControlFilter filter = new KickOutSessionControlFilter();
        filter.setKickOutUrl("/login.jsp?kickOut=1");
        filter.setSessionManager(this.sessionManager());
        filter.setLoggedSessionCache(this.cacheManager().getCache("shiro-kickOut-session"));
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean() {
        ...
        filterMap.put("kickOut", this.concurrentLoginControlFilter());
        ...
        urlMappings.put("/**", "kickOut," + DefaultFilter.user.name());
