...
/**
 * 自定义的{@link org.apache.shiro.realm.Realm}实现类
 * <p>
 * {@link org.apache.shiro.realm.Realm}的作用：
 * <ol>
 *     <li>
 ...
 * @date 2022/1/28 9:40
 */
public class CustomShiroRealm implements Realm {
    private final Logger LOG = getLogger(CustomShiroRealm.class);

    private static final String USERNAME_IN_INI_CONFIG = "zhang";
    private static final String PASSWORD_IN_INI_CONFIG = "123";

    /**
     * 获取{@link CustomShiroRealm}在应用中的唯一名称
     *
     * @return {@link CustomShiroRealm}在应用中的唯一名称
     * @author shiloh
     * @date 2022/1/28 9:43
     */
    @Override
    ...
    /**
     * 如果该{@link CustomShiroRealm}支持传入的{@link AuthenticationToken}则返回{@code true}，否则返回{@code false}
     * <p>
